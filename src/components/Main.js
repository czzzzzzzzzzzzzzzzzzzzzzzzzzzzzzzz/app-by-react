  ...
  render() {
    ...
    if (this.props.range.rotate) {
      (['MozTransform', 'msTransform', 'WebkitTransform', 'transform']).forEach(function (value) {
        styleObj[value] = 'rotate(' + this.props.range.rotate + 'deg)';
      }.bind(this));
    }
...
class App extends React.Component {
  ...
  render() {
    ...
    imageDatas.forEach(function (value, index) {
      ...
      imgFigures.push(
        <ImgFigure key={index} data={value} ref={'imgFigure' + index} range={this.state.imgsArrangeArr[index]} inverse={this.inverse(index)} center={this.center(index)} />);
      controllerUnits.push(<ControllerUnit key={index} range={this.state.imgsArrangeArr[index]} inverse={this.inverse(index)} center={this.center(index)} />);
    }.bind(this));
